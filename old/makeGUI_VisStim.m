...
% Visual Stimulus
% Contrast
uicontrol('Style','text','Position',[10 70 90 20],'String','Contrast');
Gui.Contrast = uicontrol('Style', 'edit' , 'Position', [100 70 40 20], 'String', '100');
...
% OptoStim
uicontrol('Style','text','Position',[10 100 90 20],'String','OptoStim');
Gui.OptoStim = uicontrol('Style', 'checkbox' , 'Position', [100 105 15 15], 'value', 1);
